...
import com.subhajit.IdentityService.Services.AuthEntryPointJwt;
import com.subhajit.IdentityService.Services.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.exceptionHandling(exception -> exception.authenticationEntryPoint(point))
                ...
                .authorizeHttpRequests(auth -> auth
                                .requestMatchers("/auth/signUp","/auth/signIn","/auth/validate").permitAll() // Permit access to public URLs
